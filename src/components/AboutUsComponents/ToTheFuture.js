...
const TextCard = () => {
  return (
    <div className="card d_flex_column txt_card">
      <Hide>
        <motion.h2 variants={titleAnim}>To the Future</motion.h2>
      </Hide>
...
const EmptyCard = () => {
  return <div className="card d_flex_column empty_card bg_color_secondary"></div>;
};
//Styped components
const StyledTotheFuture = styled(motion.div)`
  display: flex;
